"""
Django settings for admin_be project.
...
SECRET_KEY = 'django-insecure-qi4oq#fk__t_=s5q3s*pe-#p*fc-zpi0+-j1!1q@--l22el*z-'
...
WSGI_APPLICATION = 'admin_be.wsgi.application'
...
AUTH_USER_MODEL = "admin_app.Login_model"
